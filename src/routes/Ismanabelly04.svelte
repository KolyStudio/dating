<script>
  ...
  let link =
    'https://www.rencontres-proximite.com/?acme=wid.90642&siteid=3461948&tpls=73&userName=Ismanabelly04&userAge=22&userPicture=https://www.zupimages.net/up/22/29/gm47.jpg&source=RENCONTRE&s1=texte_normal&s2=direct&userDistance=7&userPhotos=53'
...
<main class="mt-4 rounded-t-[40px] pb-[10px]">
  ...
  <div class="m-auto  w-[90%] rounded-[30px] border-b-4 border-[#f05e7a] bg-white p-4 text-center font-medium text-black">
    <div class="">Ismana / 22 ans / Libertine qui s'assume 🍑 <br /><br />Si tu es intéressé, envoie moi un message ici et on s'organise un truc</div>
  </div>
  ...
  <section class="m-auto mt-4 w-[90%] rounded-[30px] border-b-4 border-[#f05e7a] bg-white p-4 font-medium text-black">
    ...
    <h2 class="py-2 text-center font-bold uppercase text-[#f05e7a]">JE NE SUIS PAS UNE ESCORTE !! ❌</h2>
