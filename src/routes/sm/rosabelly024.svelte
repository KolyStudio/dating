...
<main class="m-auto h-full bg-[#ffd3eb] px-[5%]  pt-4 pb-[10px]">
  ...
  <a href={link}
    ><section id="testjs" class="w-full py-3">
      <article id="testjs" class="  m-auto flex  items-center justify-center space-x-4 rounded-[10px]  bg-[#800048]  p-5 px-2 font-bold text-white shadow-2xl">
        <button id="testjs" class="font-bold tracking-[1px] ">{`>>> ME CONTACTER MAINTENANT <<<`}</button>
      </article>
    </section></a
  >

  <div class="h-[2px] border-b-[1px] border-[#800048] py-4" />
