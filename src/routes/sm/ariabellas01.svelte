...
<svelte:head>
  <title>Ariabellas01 - Page Privée</title>
  <meta name="description" content="Accéder à la page privée de ariabellas01 pour consulter sa présentation et ses photos. ariabellas01 répond généralement aux messages privés en moins d'une heure." />
  <meta property="og:title" content="@ariabellas01" />
  <meta property="profile:username" content="ariabellas01" />
...
<div class="m-auto flex w-[300px] max-w-[400px] flex-col pt-4 ">
  <div class="m-auto flex items-center space-x-1">
    <img src="/mask.png" alt="ariabellas01" class="w-[60px]" />
  </div>
...
<main class="mt-4 rounded-t-[40px]   pb-[10px]">
  ...
  <section>
    ...
    <article class="relative m-auto mb-5 w-[170px] rounded-[50px] bg-gradient-to-r from-[#ffacbc] to-[#ffacbc] p-[4px] shadow-xl ">
      <img class="m-auto w-[200px] rounded-[50px] border-[5px] border-white" src="/ismanabelly.webp" alt="ariabellas01" />
  ...
  <section>
    <section class="m-auto mt-4 w-[90%]  rounded-[30px] bg-gradient-to-r from-[#f05e7a] to-[#f05e7a] p-1  shadow-xl">
      <img src="/proof.webp" alt="ariabellas01" class="rounded-[30px] border-[4px] border-white" />
  ...
  <section>
    ...
    <article>
      <div class="m-auto mt-4 w-[90%]  rounded-[30px] border-b-4 border-[#f05e7a] bg-gradient-to-r from-[#c9c9c9] to-[#c9c9c9] shadow-xl">
        <img src="/reviews/rev1.jpg" alt="ariabellas01" class="rounded-[30px] border-[4px] border-white" />
      </div>
    ...
    <article>
      <div class="m-auto mt-4 w-[90%]  rounded-[30px]   border-b-4 border-[#f05e7a] bg-gradient-to-r from-[#c9c9c9] to-[#c9c9c9]  shadow-xl ">
        <img src="/reviews/rev3.jpg" alt="ariabellas01" class="rounded-[30px] border-[4px] border-white" />
      </div>
